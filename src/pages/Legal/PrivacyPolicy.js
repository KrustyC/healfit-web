...
export default () => (
  <>
    ...
    <P>
      ...
      have associated with that data. Our Privacy Policy for Healfit is based on
      the{' '}
    ...
    <P>
      Healfit will take all steps reasonably necessary to ensure that your data
    ...
    <P>
      Healfit may disclose your Personal Data in the good faith belief that such
