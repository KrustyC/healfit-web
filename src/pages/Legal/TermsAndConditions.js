...
export default () => (
  <Fragment>
    ...
    <P>
      ...
      of Healfit{"'"}s Website.
    </P>{' '}
    <br />
    <span style={{ textTransform: 'capitalize' }}> Healfit</span> is located at:
    <br />
    <address>
      62 Sisters Avenue , London
      <br />
      London - SW11 5SN, United Kingdom
      <br />
    </address>
    <P>
      By accessing this website we assume you accept these terms and conditions
      in full. Do not continue to use Healfit{"'"}s website if you do not accept
    ...
    <Heading level="h2">Cookies</Heading>
    <P>
      We employ the use of cookies. By using Healfit{"'"}s website you consent
      to the use of cookies in accordance with Healfit{"'"}s privacy policy.
    </P>
    <P>
    ...
    <Heading level="h2">License</Heading>
    <P>
      Unless otherwise stated, Healfit and/or it’s licensors own the
      intellectual property rights for all material on Healfit. All intellectual
      property rights are reserved. You may view and/or print pages from
      http://healfit.co.uk for your own personal use subject to restrictions set
      in these terms and conditions.
    </P>
    <P>You must not:</P>
    <ol>
      <li>Republish material from http://healfit.co.uk</li>
      <li>Sell, rent or sub-license material from http://healfit.co.uk</li>
      <li>Reproduce, duplicate or copy material from http://healfit.co.uk</li>
    </ol>
    <P>
      Redistribute content from Healfit (unless content is specifically made for
      redistribution).
    </P>
    <Heading level="h2">Hyperlinking to our Content</Heading>
    <ol>
      <li>
    ...
    <P>
      ...
      visibility associated with the hyperlink outweighs the absence of Healfit;
    ...
    <P>
      ...
      e-mail to{' '}
      <a
        href="mailto:davide.crestini94@gmail.com"
        title="send an email to davide.crestini94@gmail.com"
      >
        davide.crestini94@gmail.com
      </a>
    ...
    <P>
      No use of Healfit{"'"}s logo or other artwork will be allowed for linking
      absent a trademark license agreement.
    </P>
    <Heading level="h2">Iframes</Heading>
    <P>
    ...
    <Heading level="h2">Reservation of Rights</Heading>
    <P>
    ...
    <Heading level="h2">Removal of links from our website</Heading>
    <P>
    ...
    <Heading level="h2">Content Liability</Heading>
    <P>
    ...
    <Heading level="h2">Disclaimer</Heading>
    <P>
    ...
    <Heading level="h2">Credit {'&'} Contact Information</Heading>
    <P>
      This Terms and conditions page was created at{' '}
      <Link to="https://termsandconditionstemplate.com">
